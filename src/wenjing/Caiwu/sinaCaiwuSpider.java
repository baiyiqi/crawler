...
import wenjing.TestTool.fenghuangSpider;
...
public class sinaCaiwuSpider extends DeepCrawler {
	...
	public sinaCaiwuSpider(String crawlPath) {
		super(crawlPath);
		// TODO Auto-generated constructor stub
		
		//http://finance.sina.com.cn/stock/s/20150917/010923268489.shtml
		regexRule.addRule("http://finance.sina.com.cn/stock/.*.shtml");
	...
	public Links visitAndGetNextLinks(Page page) {
		...
		Elements newsContentElment = doc.select("div#artibody");
		...
		String newsTitle = doc.select("h1#artibodyTitle").text();
...
//		countingNumber++;
	...
	public static void main(String[] args) {
		...
		sinaCaiwuSpider crawler = new sinaCaiwuSpider(
				"/Users/y/Desktop/testWebcollecter/data/sinaCaiWu");
		
		crawler.addSeed("http://finance.sina.com.cn/stock/");
