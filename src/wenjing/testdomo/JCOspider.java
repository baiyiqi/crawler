...
public class JCOspider extends DeepCrawler {
	...
	public JCOspider(String crawlPath) {
		super(crawlPath);
		// TODO Auto-generated constructor stub

		regexRule.addRule("http://www.medsci.cn/article/show_article.*");
	...
	public Links visitAndGetNextLinks(Page page) {
		...
		String newsTitle = doc.select("div#rightwidecolumn>h1").text();
...
//		
		...
		String newsContent = doc.select("div.news_content").text();
	...
	public static void main(String[] args) {
		...
		JCOspider crawler = new JCOspider(
		...
		String pageUrl = "http://www.medsci.cn/article/list.do?s_id=64&page=";
		for (int i = 1; i < 10; i++) {
