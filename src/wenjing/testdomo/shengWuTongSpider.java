...
public class shengWuTongSpider extends DeepCrawler {
	...
	public shengWuTongSpider(String crawlPath) {
		super(crawlPath);
		// TODO Auto-generated constructor stub

//		regexRule.addRule("http://www.ebiotrade.com/newsf/read.*");
		regexRule.addRule("http://www.ebiotrade.com/newsf/201.*");
...
//		//news kind parsing
		...
		String src = srcExactor. getSrc("来源：(.*)</i>",doc.toString());
	
		String picUrl = doc.select("div.b-mhcon>div>img").attr("src");

		Elements newsContentElment = doc.select("div#Zoom");
		...
		String newsTitle = doc.select("p.p1Title").text();
		...
		nextLinks.addAllShengWuTongFromDocument(doc, regexRule);
		return nextLinks;
	}
	...
	public static void main(String[] args) {
		...
		shengWuTongSpider crawler = new shengWuTongSpider(
		...
		String pageUrl = "http://www.ebiotrade.com/newsf/list.asp?boardid=0&page=";
		for (int i = 2; i < 10; i++) {
