...
public abstract class Crawler implements VisitorFactory {
    ...
    //wenjing 获取集成好功能的 httpRequester
    ...
    //wenjing entrance method for crawler
    public void start(int depth) throws Exception {
        File dir = new File(crawlPath);
        boolean needInject = true;
        //using database file and reusualbe to judge if focusd crawling
        ...
        for (int i = 0; i < depth; i++) {
            ...
            //generator is the class link db. 
