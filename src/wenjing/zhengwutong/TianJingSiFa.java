...
public class TianJingSiFa extends DeepCrawler {
	...
	public TianJingSiFa(String crawlPath) {
		super(crawlPath);
		// TODO Auto-generated constructor stub
		
		regexRule.addRule("http://www.tjsf.gov.cn/system/.*");
	...
	//#articleContent > p:nth-child(2) > a > img
		...
		String picUrl = doc.select("td.zi14.hanggao35 > div >div > span > img").attr("src");
	

		Elements newsContentElment = doc.select("td.zi14.hanggao35  ");
	...
	public static void main(String[] args){
		...
		TianJingSiFa crawler = new TianJingSiFa(
				"/Users/y/Desktop/testWebcollecter/data/TianJingSiFa");
		crawler.setThreads(5);
	
		
	
		String pageUrl = "http://www.tjsf.gov.cn/tpxw/index.shtml";
//		for (int i = 1; i < 20; i++) {
