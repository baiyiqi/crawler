...
public class biodiscoverSpider extends DeepCrawler {
	...
	public biodiscoverSpider(String crawlPath) {
		super(crawlPath);
		// TODO Auto-generated constructor stub
		
		regexRule.addRule("http://www.biodiscover.com/news/.*.html");
	...
	public Links visitAndGetNextLinks(Page page) {
		...
		if(url.contains("news")){
			...
			String src = doc.select("a.fc999").text();
	
		
		String picUrl = doc.select("div.view-content.t-35.news-view.clearfix>p>img").attr("src");
	...
	public static void main(String[] args){
		...
		biodiscoverSpider crawler = new biodiscoverSpider(
				"/Users/y/Desktop/testWebcollecter/data/biodiscoverSpider");
		crawler.setThreads(5);
	
		
	
		String pageUrl = "http://www.biodiscover.com/news.html?1=1&page=";
		for (int i = 1; i < 20; i++) {
