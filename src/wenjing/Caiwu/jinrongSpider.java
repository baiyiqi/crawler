...
public class jinrongSpider extends DeepCrawler {
	...
	public jinrongSpider(String crawlPath) {
		super(crawlPath);
		// TODO Auto-generated constructor stub
		
		//http://finance.sina.com.cn/stock/s/20150917/010923268489.shtml
		regexRule.addRule("http://.*.jrj.com.cn/2015/09/.*.shtml");
	...
	public Links visitAndGetNextLinks(Page page) {
		...
		Elements newsContentElment = doc.select("div.texttit_m1");
		...
		String newsTitle = doc.select("div.titmain>h1").text();
...
//		countingNumber++;
	...
	public static void main(String[] args) {
		...
		jinrongSpider crawler = new jinrongSpider(
				"/Users/y/Desktop/testWebcollecter/data/jinrongSpider");
		
		crawler.addSeed("http://opinion.jrj.com.cn/");
